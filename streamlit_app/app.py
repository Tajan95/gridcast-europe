...
FUTURE_PATH_HELP = (
    ...
    "je 102 % des typischen direkten und diffusen Strahlungsprofils. "
    "Quellenbefund und Modellierungsentscheidung sind dabei getrennt: "
    "Die +35 % orientieren sich direkt am TYNDP-2024-Szenario Global "
    "Ambition. Die +1,5 °C sind eine aus dem EEA-Trend abgeleitete "
    "Stressannahme, keine Prognose für jedes Land. Die +2.000 MW je "
    "ausgewähltem Land sind eine illustrative Übersetzung des von der IEA "
    "projizierten europäischen Rechenzentrumsanstiegs, nicht dessen "
    "Originalwert. Die 102 % übertragen den abgeschwächten europäischen "
    "Brightening-Trend von weniger als 1 W/m² pro Jahrzehnt bis 2054 "
    "konservativ auf die Regler. Weil die Studie keine robuste Aufteilung "
    "auf direkte und diffuse Anteile liefert, skaliert die App beide als "
    "eigene Vereinfachung gleich. Der Pfad ist somit keine länderscharfe "
    "Prognose. Quellen: [EEA – Global and European "
